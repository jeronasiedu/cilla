...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // setLoading(true);
      // const hasOrganisation = await login(email, password);
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // const hasOrganisation = await continueWithGoogle();
      ...
      <section className={"w-full md:w-1/2"}>
        <div className="md:pt-48 pt-16 p-4 flex flex-col items-center max-w-sm mx-auto">
          ...
          <p className={"mb-2 mt-1 md:hidden"}>
            Manage your plants and nutrients
          </p>
          <h2 className={"mb-6 md:mb-2"}>Login to your account</h2>
