...
const DesiredCropsYieldModal = () => {
  const close = useDesiredCropsStore((state) => state.close);
  const cb = useDesiredCropsStore((state) => state.cb);
  ...
  return (
    <ModalWrapper>
      <div className="flex items-center justify-between p-4 bg-white border-b md:border-b-0 sticky top-0 z-20">
        <h3 className="text-lg md:text-xl">Enter Desired Yields</h3>
...
export default DesiredCropsYieldModal;
